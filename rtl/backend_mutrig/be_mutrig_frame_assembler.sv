...
// MuTRiG backend frame assembler - raw-frame_gen-compatible 8b/1k output.
// Author: Yifeng Wang
// Version : 26.2.0
// Date    : 20260502
...
#(
    ...
    fsm_t        p_state;
    fsm_t        n_state;
    logic [EVENT_COUNT_WIDTH-1:0] p_event_count;
    logic [EVENT_COUNT_WIDTH-1:0] n_event_count;
    logic [EVENT_COUNT_WIDTH-1:0] p_event_cnt_decr;
    logic [EVENT_COUNT_WIDTH-1:0] n_event_cnt_decr;
    logic [15:0] p_frame_count;
    logic [15:0] n_frame_count;
    logic [2:0]  p_byte_count;
    logic [2:0]  n_byte_count;
    logic [47:0] p_event_data_srg;
    logic [47:0] n_event_data_srg;
    logic        p_sc_fast_mode;
    logic        n_sc_fast_mode;
    logic        p_pack_event_odd;
    logic        n_pack_event_odd;
    logic        p_last_event;
    logic        n_last_event;
    logic        p_fifo_full;
    logic        n_fifo_full;
    ...
    assign txmode_fast = (cfg_tx_mode == 3'b100);
